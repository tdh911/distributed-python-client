...
def get_parser():
    parser = argparse.ArgumentParser(description="Make call to distributed db")
    ...
    parser.add_argument("--endpoint", dest="endpoint", default="http://localhost:8080", help="Where distributed db is running")
